...
class PersonaController extends Controller
{
    ...
    public function buscar(Request $request)
    {
        ...
        $resultado        = Person::where(function($sql) use($nombre){
                                    $sql->where(DB::raw('CONCAT(apellidopaterno," ",apellidomaterno," ",nombres)'), 'LIKE', '%'.strtoupper($nombre).'%')->orWhere(DB::raw('CONCAT(ruc," ",razonsocial)'), 'LIKE', '%'.strtoupper($nombre).'%');
                                })
    ...
    public function store(Request $request)
    {
        ...
        $error = DB::transaction(function() use($request){
            ...
            $person->razonsocial = strtoupper($request->input('razonsocial'));
            ...
            $person->cuenta = strtoupper($request->input('cuenta'));
            $person->save();
