...
{
    protected $folderview      = 'app.tipocompra';
    protected $tituloAdmin     = 'Tipo Compra';
    protected $tituloRegistrar = 'Registrar tipo compra';
    protected $tituloModificar = 'Modificar tipo compra';
    protected $tituloEliminar  = 'Eliminar tipo compra';
    ...
    public function buscar(Request $request)
    {
        ...
        $resultado        = Tipodocumento::where('tipomovimiento_id','=',1);
        if($request->input('nombre')!=""){
            $resutlado = $resultado->where('nombre','like','%'.$request->input('nombre').'%');
        }
        $resultado = $resultado->orderBy('nombre', 'ASC');
        $lista            = $resultado->get();
        $cabecera         = array();
    ...
    public function store(Request $request)
    {
        ...
        $error = DB::transaction(function() use($request){
            ...
            $tipodocumento->tipomovimiento_id = 1;
            $tipodocumento->save();
        });
