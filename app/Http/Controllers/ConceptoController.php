...
class ConceptoController extends Controller
{
    ...
    public function buscar(Request $request)
    {
        ...
        $resultado        = Concepto::where('nombre', 'LIKE', '%'.strtoupper($nombre).'%')->where('tipo','LIKE','%'.$request->input('tipo').'%')->orderBy('nombre', 'ASC');
        $lista            = $resultado->get();
        $cabecera         = array();
    ...
    public function create(Request $request)
    {
        ...
        $boton               = 'Registrar'; 
        return view($this->folderview.'.mant')->with(compact('concepto', 'formData', 'entidad', 'boton', 'listar', 'cboTipo'));
    }
