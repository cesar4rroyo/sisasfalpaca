...
function Reporte(entidad){
    window.open("venta/pdf2?fechainicio="+$('#fechainicio').val()+"&fechafin="+$("#fechafin").val()+"&cliente="+$("#cliente").val()+"&tipodocumento="+$("#tipodocumento").val()+"&tipo="+$("#tipo").val()+"&_token="+$(IDFORMBUSQUEDA + '{!! $entidad !!} :input[name="_token"]').val(),"_blank");
}
function Excel(entidad){
    window.open("venta/excel?fechainicio="+$('#fechainicio').val()+"&fechafin="+$("#fechafin").val()+"&cliente="+$("#cliente").val()+"&tipodocumento="+$("#tipodocumento").val()+"&tipo="+$("#tipo").val()+"&_token="+$(IDFORMBUSQUEDA + '{!! $entidad !!} :input[name="_token"]').val(),"_blank");
}
</script>