...
{!! Form::model($cheque, $formData) !!}	
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
        		...
        		<div class="col-lg-10 col-md-10 col-sm-10">
        			{!! Form::text('numero', is_null($cheque->movimientoref)?'':$cheque->movimientoref->numero, array('class' => 'form-control input-xs', 'id' => 'numero', 'readonly' => 'true')) !!}
        			{!! Form::hidden('movimiento_id', $cheque->movimiento_id, array('class' => 'form-control input-xs', 'id' => 'movimiento_id')) !!}
        			{!! Form::hidden('person_id', $cheque->persona_id, array('class' => 'form-control input-xs', 'id' => 'person_id')) !!}
        		</div>
        	</div>
        	<div class="form-group">
        	    {!! Form::label('banco', 'Banco:', array('class' => 'col-lg-2 col-md-2 col-sm-2 control-label')) !!}
                <div class="col-lg-3 col-md-3 col-sm-3">
                    {!! Form::select('banco',$cboBanco, $cheque->banco_id, array('class' => 'form-control input-xs', 'id' => 'banco')) !!}
                </div>
                {!! Form::label('moneda', 'Moneda:', array('class' => 'col-lg-1 col-md-1 col-sm-1 control-label')) !!}
                <div class="col-lg-2 col-md-2 col-sm-2">
                    {!! Form::select('moneda',$cboMoneda, $cheque->moneda, array('class' => 'form-control input-xs', 'id' => 'moneda')) !!}
                </div>
                {!! Form::label('numeroref', 'Numero:', array('class' => 'col-lg-2 col-md-2 col-sm-2 control-label')) !!}
                <div class="col-lg-2 col-md-2 col-sm-2">
                    {!! Form::text('numeroref', $cheque->numero, array('class' => 'form-control input-xs', 'id' => 'numeroref')) !!}
                </div>
        	</div>
            <div class="form-group">
        		<div class="col-lg-12 col-md-12 col-sm-12 text-right">
        			{!! Form::button('<i class="fa fa-check fa-lg"></i> '.$boton, array('class' => 'btn btn-success btn-sm', 'id' => 'btnGuardar', 'onclick' => '$(\'#listProducto\').val(carro);$(\'#listPago\').val(carroDoc);guardarCheque(\''.$entidad.'\', this);')) !!}
        ...
        <div class="col-lg-6 col-md-6 col-sm-6" >
            <div class="form-group">
                {!! Form::label('fecha', 'Fecha Giro:', array('class' => 'col-lg-2 col-md-2 col-sm-2 control-label')) !!}
        		<div class="col-lg-3 col-md-3 col-sm-3">
        			{!! Form::date('fecha', $cheque->fecha, array('class' => 'form-control input-xs', 'id' => 'fecha')) !!}
        		</div>
        		{!! Form::label('fechavencimiento', 'Fecha Venc.:', array('class' => 'col-lg-2 col-md-2 col-sm-2 control-label')) !!}
        		<div class="col-lg-3 col-md-3 col-sm-3">
        			{!! Form::date('fechavencimiento', $cheque->fechavencimiento, array('class' => 'form-control input-xs', 'id' => 'fechavencimiento')) !!}
        		</div>
        	</div>
        	<div class="form-group">
                {!! Form::label('total', 'Total:', array('class' => 'col-lg-2 col-md-2 col-sm-2 control-label')) !!}
        		<div class="col-lg-3 col-md-3 col-sm-3">
        			{!! Form::text('total', $cheque->total, array('class' => 'form-control input-xs', 'id' => 'total')) !!}
        		</div>
        	</div> 
        </div>     
    </div>
...
var contador=0;
function guardarCheque (entidad, idboton) {
    var band=true;
    var msg="";
