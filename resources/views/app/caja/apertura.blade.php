...
{!! Form::model($entidad, $formData) !!}	
	...
	<div class="form-group">
		{!! Form::label('total', 'Total (S/):', array('class' => 'col-lg-4 col-md-4 col-sm-4 control-label')) !!}
		<div class="col-lg-4 col-md-4 col-sm-4">
			{!! Form::text('total', $total, array('class' => 'form-control input-xs', 'id' => 'total')) !!}
		</div>
	</div>
	<div class="form-group">
		{!! Form::label('totalpagado', 'Total ($):', array('class' => 'col-lg-4 col-md-4 col-sm-4 control-label')) !!}
		<div class="col-lg-4 col-md-4 col-sm-4">
			{!! Form::text('totalpagado', $totalpagado, array('class' => 'form-control input-xs', 'id' => 'totalpagado')) !!}
		</div>
	</div>
    <div class="form-group">
