					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="form-group">
								...
								{!! Form::select('tipomaquinaria', $cboTipomaquinaria, '', array('class' => 'form-control input-xs', 'id' => 'tipomaquinaria')) !!}
							</div>
							<div class="form-group">
...
<script>
	...
	function pdf(id){
    window.open("maquinaria/pdf?id="+id+"&_token="+$(IDFORMBUSQUEDA + '{!! $entidad !!} :input[name="_token"]').val(),"_blank");
}
</script>