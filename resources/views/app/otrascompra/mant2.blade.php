    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
        		...
        		<div class="col-lg-10 col-md-10 col-sm-10">
        			{!! Form::text('proveedor', $movimiento->persona->razonsocial, array('class' => 'form-control input-xs', 'id' => 'proveedor', 'readonly' => 'true')) !!}
        			{!! Form::hidden('person_id', $movimiento->persona_id, array('class' => 'form-control input-xs', 'id' => 'person_id')) !!}
        		</div>
        	</div>
        	<div class="form-group">
        	    {!! Form::label('banco', 'Banco:', array('class' => 'col-lg-2 col-md-2 col-sm-2 control-label')) !!}
                <div class="col-lg-3 col-md-3 col-sm-3">
                    {!! Form::select('banco',$cboBanco, $movimiento->banco_id, array('class' => 'form-control input-xs', 'id' => 'banco')) !!}
                </div>
        	    {!! Form::label('moneda', 'Moneda:', array('class' => 'col-lg-1 col-md-1 col-sm-1 control-label')) !!}
                <div class="col-lg-2 col-md-2 col-sm-2">
                    {!! Form::select('moneda',$cboMoneda, $movimiento->moneda, array('class' => 'form-control input-xs', 'id' => 'moneda')) !!}
                </div>
            </div>
        	<div class="form-group">
                {!! Form::label('comentario', 'Comentario:', array('class' => 'col-lg-2 col-md-2 col-sm-2 control-label')) !!}
                <div class="col-lg-5 col-md-5 col-sm-5">
                    {!! Form::textarea('comentario', $movimiento->comentario, array('class' => 'form-control input-xs', 'id' => 'comentario', 'rows' => '3')) !!}
                </div>
        	</div>
            <div class="form-group">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6" >
            <div class="form-group">
        		...
        		<div class="col-lg-3 col-md-3 col-sm-3">
        			{!! Form::date('fecha', $movimiento->fecha, array('class' => 'form-control input-xs', 'id' => 'fecha')) !!}
        		</div>
        		{!! Form::label('cantidad', 'Nro:', array('class' => 'col-lg-2 col-md-2 col-sm-2 control-label')) !!}
        		<div class="col-lg-3 col-md-3 col-sm-3">
        			{!! Form::text('cantidad', $movimiento->numero, array('class' => 'form-control input-xs', 'id' => 'cantidad')) !!}
        		</div>
        	</div>
        	<div class="form-group">
                {!! Form::label('total', 'Total:', array('class' => 'col-lg-2 col-md-2 col-sm-2 control-label')) !!}
        		<div class="col-lg-3 col-md-3 col-sm-3">
        			{!! Form::text('total', $movimiento->total, array('class' => 'form-control input-xs', 'id' => 'total')) !!}
        		</div>
        	</div> 
        </div>     
    </div>
