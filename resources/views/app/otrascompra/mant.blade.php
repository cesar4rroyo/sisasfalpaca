        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
        		...
        		<div class="col-lg-9 col-md-9 col-sm-9">
        		    {!! Form::hidden('persona_id', null, array('class' => 'form-control input-xs', 'id' => 'persona_id')) !!}
                    {!! Form::text('persona', null, array('id' => 'persona','class' => 'form-control input-xs')) !!}
                </div>
            </div>
        	<div class="form-group">
        		{!! Form::label('banco_id', 'Banco:', array('class' => 'col-lg-2 col-md-2 col-sm-2 control-label')) !!}
        		<div class="col-lg-3 col-md-3 col-sm-3">
                {!! Form::select('banco_id', $cboBanco, null, array('id' => 'banco_id','class' => 'form-control input-xs')) !!}
                </div>
                {!! Form::label('totalpagado', 'Inicial:', array('class' => 'col-lg-2 col-md-2 col-sm-2 control-label')) !!}
        		<div class="col-lg-2 col-md-2 col-sm-2">
                {!! Form::text('totalpagado', null, array('id' => 'totalpagado','class' => 'form-control input-xs')) !!}
                </div>
        	</div>
        	<div class="form-group">
