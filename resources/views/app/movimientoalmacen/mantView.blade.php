    ...
    <div class="row">
    	<div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3">
                    {!! Form::select('almacen_id', $cboAlmacen, null, array('class' => 'form-control input-xs', 'id' => 'almacen_id', 'readonly'=>'')) !!}
                </div>
            </div>
    	</div>
     </div>
            ...
            <table class="table table-condensed table-border" id="tbDetalle">
                ...
                @foreach($detalles as $key => $value)
					<tr>
                        ...
                        <td class="text-left">{!! ($value->producto_id>0?$value->producto2:$value->producto) !!}</td>
