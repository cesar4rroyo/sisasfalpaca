					...
					<div class="row">
						<div class="col-xs-12">
                            ...
                            <div class="form-group">
								...
								{!! Form::select('especialidad', $cboEspecialidad, '', array('class' => 'form-control input-xs', 'id' => 'especialidad')) !!}
							</div>
                            <div class="form-group">
								{!! Form::label('ciclo', 'Ciclo:') !!}
								{!! Form::select('ciclo', $cboCiclo, '', array('class' => 'form-control input-xs', 'id' => 'ciclo')) !!}
							</div>
							<div class="form-group">
