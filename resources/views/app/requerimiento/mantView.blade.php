...
{!! Form::model($venta, $formData) !!}
    ...
    <div class="row">
    	<div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="form-group">
        		{!! Form::label('persona', 'Personal:', array('class' => 'col-lg-1 col-md-1 col-sm-1 control-label')) !!}
            ...
            <table class="table table-condensed table-border" id="tbDetalle">
                ...
                @foreach($detalles as $key => $value)
					<tr>
                        ...
                        <td class="text-left"><textarea  rows='2' cols='50' class='form-control input-xs'>{!! ($value->producto_id>0?$value->producto2:$value->producto) !!}</textarea></td>
					</tr>
                @endforeach
                </tbody>
            </table>
